    ...
    <body>
        ...
        <center>
            ...
            <?php  if($pagina_anterior != 0) : ?>
                    <a href="funcionarios.php?pagina=<?php echo $pagina_anterior; ?>" > 
                        &laquo;
                    </a>
            <?php  endif; ?>
            <?php for($i = 1; $i < $numero_pagina + 1; $i++): ?>
                <a href="funcionarios.php?pagina=<?php echo $i; ?>"> 
                    <?php echo $i; ?> 
                </a>
            <?php endfor; ?>
            <?php  if($pagina_posterior <= $numero_pagina) : ?>
                    <a href="funcionarios.php?pagina=<?php echo $pagina_posterior; ?>" > 
                        &raquo;
                    </a>
            <?php  endif; ?>
        </center>
